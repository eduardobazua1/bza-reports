...
export default async function PurchaseOrderDetailPage({
  ...
  const statusColors: Record<string, string> = {
    active: "bg-stone-100 text-[#0d9488]",
    completed: "bg-stone-100 text-[#0d9488]",
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-5">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              {certType === "fsc" && (
                <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-stone-100 text-[#0d9488] uppercase tracking-wide">FSC</span>
              )}
              {certType === "pefc" && (
                <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-stone-100 text-[#0d9488] uppercase tracking-wide">PEFC</span>
              )}
              {!certType && (
      ...
      <div className="bg-white rounded-md shadow-sm p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
          ...
          <div>
            ...
            <p className={`text-xl font-semibold mt-1 ${totalProfit >= 0 ? "text-[#0d9488]" : "text-[#0d3d3b]"}`}>
