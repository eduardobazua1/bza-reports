...
export default async function APAgingDetailPage({
  ...
  const exportHeaders = ["Date", "Invoice", "Supplier", "Amount", "Open Balance", "Days"];
  const exportRows = filteredInvoices.map(inv => {
    ...
    return {
      "Date": fmt(inv.shipmentDate ?? null),
  ...
  return (
    <AgingDetailToolbar
      ...
      backHref="/reports/ap-aging-summary"
      backLabel="← Back to summary"
      filename="AP-Aging-Detail"
      emailSubject="A/P Aging Detail Report — BZA International Services"
