        ...
        {step === "email" ? (
          ...
          <form onSubmit={handleVerify}>
            ...
            <input
              ...
              maxLength={6}
              placeholder="000000"
              className="w-full bg-[#fafaf9] border-[1.5px] border-[#e7e5e4] rounded-xl px-4 py-4 text-[22px] text-center tracking-[10px] text-[#1c1917] focus:outline-none focus:border-[#0d3d3b] focus:bg-white transition-colors mb-5"
            />
