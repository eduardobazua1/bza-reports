      ...
      <table className="w-full text-xs">
            ...
            return [
              ...
              ...(isOpen ? [
                <tr key={`sub-${group.name}`} className="border-t border-stone-200 bg-stone-50">
                  ...
                  <td className="px-4 py-2 text-right font-bold text-[#0d3d3b]">{formatCurrency(subtotal)}</td>
        ...
        <tfoot>
          <tr className="border-t-2 border-stone-400">
            ...
            <td className="px-4 py-3 text-right font-bold text-[#0d3d3b] text-base">{formatCurrency(grandTotal)}</td>
