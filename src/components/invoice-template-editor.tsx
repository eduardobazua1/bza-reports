      ...
      <div className="p-4 space-y-6">
        ...
        <div>
          ...
          <div className="flex gap-6">
            <div>
              <label className="block text-xs text-[#0d3d3b] mb-1">Primary Color</label>
            ...
            <div>
              <label className="block text-xs text-[#0d3d3b] mb-1">Accent Color</label>
              <div className="flex items-center gap-2">
                <input
                  type="color"
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="block text-xs text-[#0d3d3b] mb-1">Additional Notes (shown at bottom of invoice)</label>
              <textarea
                className="w-full border border-stone-200 rounded px-2 py-1.5 text-sm"
                rows={3}
