                ...
                {supplierPayments.map(p => {
                  ...
                  return (
                    <tr key={p.id} className="border-t border-border hover:bg-muted/50 transition-colors">
                      ...
                      <td className="p-3 text-xs text-[#0d3d3b]">{p.supplierName || "—"}</td>
                      ...
                      <td className="p-3 text-xs text-right text-[#0d3d3b]">{p.estimatedTons?.toFixed(1) ?? "—"}</td>
                      <td className="p-3 text-xs text-right text-[#0d3d3b]">{p.actualTons?.toFixed(1) ?? "—"}</td>
                      ...
                      <td className="p-3 text-xs text-[#0d3d3b]">{p.paymentMethod || "—"}</td>
                      <td className="p-3 text-xs text-[#0d3d3b]">{p.reference || "—"}</td>
                    </tr>
                  );
                })}
              </tbody>
              {supplierPayments.length > 0 && (
                <tfoot>
                  <tr className="bg-muted font-semibold border-t-2 border-border">
                    <td className="p-3 text-xs text-[#0d3d3b]" colSpan={3}>TOTAL</td>
