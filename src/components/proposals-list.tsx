            ...
            <tbody>
              {filtered.map(p => (
                <tr key={p.id} className="hover:bg-muted/50 transition-colors">
                  <td className="p-3 text-xs text-[#0d3d3b] border-t border-border">{p.proposalNumber}</td>
                  <td className="p-3 text-xs text-[#0d3d3b] border-t border-border">{p.clientName || "—"}</td>
                  <td className="p-3 text-xs text-[#0d3d3b] max-w-[200px] truncate border-t border-border">{p.title}</td>
                  ...
                  <td className="p-3 text-xs text-right font-semibold text-[#0d3d3b] border-t border-border">{formatCurrency(p.total)}</td>
                  <td className="p-3 border-t border-border">
                    <Link
                      href={`/proposals/${p.id}`}
