        ...
        {!isPending && (
          <div className="flex items-center gap-1.5 bg-stone-50 rounded-md px-2 py-1">
            ...
            <a
              ...
              className="flex items-center gap-1 text-[11px] text-stone-600 hover:text-blue-600 hover:underline"
            >
        ...
        {docs.map((doc) => (
          <div key={doc.id} className="flex items-center gap-1.5 bg-stone-50 rounded-md px-2 py-1 group">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 text-[11px] text-stone-600 hover:text-blue-600 hover:underline truncate max-w-[120px]"
              title={doc.fileName}
            >
              <svg className="w-3 h-3 text-blue-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" /></svg>
              {doc.fileName}
