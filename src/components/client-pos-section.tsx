...
export function ClientPOsSection({
  ...
  const statusColors: Record<string, string> = {
    ...
    complete: "bg-[#e6f1ee] text-[#0d3d3b]",
  };
                ...
                return (
                  <Fragment key={cpo.id}>
                    <tr className={`hover:bg-stone-50 ${editingId === cpo.id ? "bg-[#0d3d3b]/40" : ""}`}>
                      ...
                      <td className="px-4 py-3 border-t border-stone-100 text-xs text-[#0d3d3b]">{cpo.item || "—"}</td>
                      ...
                      <td className="px-4 py-3 border-t border-stone-100 text-right text-xs text-[#0d3d3b]">
                        ...
                        <td colSpan={10} className="p-0">
                          <div className="bg-stone-50 border-t border-stone-200 p-4 space-y-3">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                              ...
                              <div>
                                <label className="block text-xs text-[#0d3d3b] mb-1">Sell Price/TN</label>
                                <input
      ...
      {adding && (
        <div className="p-4 border-t border-stone-100 bg-stone-50 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div>
              <label className="block text-xs text-[#0d3d3b] mb-1">Planned Tons</label>
              <input
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div>
              <label className="block text-xs text-[#0d3d3b] mb-1">Price/TN override</label>
              <input
                type="number" step="0.01"
                className="w-full border border-stone-200 rounded px-2 py-1.5 text-sm"
          ...
          {addForm.plannedTons && (
            <p className="text-xs text-[#0d3d3b]">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => setAdding(false)} className="text-xs text-[#0d3d3b] hover:text-stone-700 px-3 py-1.5">
              Cancel
            </button>
          </div>
        </div>
      ...
      {openDropdownId !== null && dropdownPos && (() => {
        ...
        return createPortal(
          <div ref={dropdownRef} style={{ position: "fixed", top: dropdownPos.top, right: dropdownPos.right, zIndex: 9999 }} className="bg-white border border-stone-200 rounded-md shadow-lg min-w-[150px] py-1 text-left">
            ...
            <button onClick={() => { setOpenDropdownId(null); handleDelete(cpo.id); }} className="flex items-center gap-2 w-full text-left px-4 py-2 text-sm text-stone-600 hover:bg-stone-50"><Trash2 className="w-3.5 h-3.5" />Delete</button>
          </div>,
          document.body
        );
      })()}
